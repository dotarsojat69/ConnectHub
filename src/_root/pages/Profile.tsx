        ...
        <div className="flex xl:flex-row flex-col max-xl:items-center flex-1 gap-7">
          ...
          <div className="flex flex-col flex-1 justify-between md:mt-2">
            <div className="flex flex-col w-full">
              <h1 className="text-center xl:text-left h3-bold md:h1-semibold w-full text-light-4">
                {currentUser.name}
              </h1>
              <p className="small-regular md:body-medium text-purple-600 text-center xl:text-left">
          ...
          <div className="flex justify-center gap-4">
            <div className={`${user.id !== currentUser.$id && "hidden"}`}>
              <Link
                ...
                className={`h-12 bg-dark-4 px-5 text-light-4 flex-center gap-2 rounded-lg ${
